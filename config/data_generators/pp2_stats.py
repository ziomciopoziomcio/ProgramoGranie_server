...
topics = [
    "Struktury",
    "Unie",
    "Dynamiczna alokacja pamięci I",
    "Dynamiczna alokacja pamięci II",
    "Dynamiczna alokacja pamięci - teksty i napisy",
    "Wskaźniki do funkcji",
    "Funkcje ze zmienną liczbą argumentów i argumenty funkcji main",
    "Operacje bitowe oraz dyrektywy preprocesora",
...
for topic in topics:
    ...
    cursor.execute("""
        INSERT INTO pp2_stats (user_id, topic_name, progress, overall_stat, completion_status, achievement_name, achievement_progress)
